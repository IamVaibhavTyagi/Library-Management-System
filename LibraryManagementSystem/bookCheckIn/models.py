...
class Borrower(models.Model):
    ...
    phone = models.CharField(db_column='Phone', max_length=14, blank=True, null=True)  # Field name made lowercase.
...
class Fines(models.Model):
    ...
    fine_amt = models.DecimalField(db_column='Fine_amt', max_digits=9, decimal_places=2)  # Field name made lowercase.
